...
install_from_github() {
  ...
  if [ -n "$LATEST_VERSION" ]; then
    ...
    VSIX_URL="https://eai-tools.github.io/specgofer/releases/eai-gofer-${LATEST_VERSION}.vsix"
...
if code --list-extensions 2>/dev/null | grep -qE "EnterpriseAI\.(specgofer|eai-gofer)"; then
