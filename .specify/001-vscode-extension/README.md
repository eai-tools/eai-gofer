...
This folder contains specifications specific to the `001-vscode-extension` branch.
...
Specifications in this folder are only active when working on the `001-vscode-extension` branch.
