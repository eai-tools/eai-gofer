...
This folder contains specifications specific to the `002-language-server` branch.
...
Specifications in this folder are only active when working on the `002-language-server` branch.
