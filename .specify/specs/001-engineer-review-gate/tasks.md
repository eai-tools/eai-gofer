...
- [ ] T001 [US1] Create engineer-review agent file at
...
- [ ] T002 [US1] Write Core Responsibilities and Analysis Strategy sections in
...
- [ ] T003 [P] [US1] Write Output Format, Blocking Criteria, Important
...
- [ ] Agent file has YAML frontmatter with name, description, tools (Read, Grep,
      Glob, LS only)
- [ ] Agent file has all 7 sections: Core Responsibilities, Analysis Strategy,
      Output Format, Blocking Criteria, Important Guidelines, LLM Council Mode
- [ ] Output format specifies <2000 token cap
- [ ] All 5 alignment areas are covered in Analysis Strategy
...
- [ ] T004 [US2] [US3] Insert new Step 4.6 "Engineer Review Gate" section in
...
- [ ] T005 [US2] Add correction loop logic to Step 4.6 in
...
- [ ] T006 [US2] Add escalation handling to Step 4.6 in
...
- [ ] Step 4.6 appears between traceability (Step 4.5) and GitHub issues
      (Step 5)
- [ ] Agent is spawned using Task tool with subagent_type="engineer-review"
- [ ] Correction loop has MAX_ITERATIONS = 3
- [ ] Escalation report generated on 3rd failure
- [ ] Auto-chaining to /5_gofer_implement is preserved when review passes

## Phase 3: Bundle for Distribution

**Goal**: Ensure agent is distributed with the VSCode extension

- [ ] T007 [P] [US3] Copy .claude/agents/engineer-review.md to
...
- [ ] File exists at extension/resources/claude-agents/engineer-review.md
