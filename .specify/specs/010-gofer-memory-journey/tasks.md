...
- [X] T020 [P] [US1] Implement `MemoryHookManager` class
  ...
  - Define hook interface: `beforeToolCall`, `afterTaskCompletion`, `onErrorRecovery`, `onUserClarification`
...
- [X] T036 [P] [US3] Create industry variant templates
  - 10 industries: retail, healthcare, finance, education, hospitality, logistics, manufacturing, legal, real_estate, entertainment
...
**Goal**: Generate 5 implementation options spanning efficiency→innovation spectrum
...
- [X] T044 [US4] Save diagrams and selection
  ...
  - Save selected: `.specify/specs/{feature}/sequence-diagrams/selected-option.md`
...
- All tasks build on existing implementation (MemoryManager, MemoryStorage, ContextBuilder)
