...
> truthfully. Internal contract IDs (IAP-030-01 through IAP-030-04) are
> provided for plan-stage traceability.
...
feature delivering new end-user AI workflow functionality to the extension
must define an app journey at that time.
...
| Boundary | Definition |
| -------- | ---------- |
| Scope | This repository only (`/Users/douglaswross/Code/eai/eai-tools/gofer`) |
...
> application service. This feature has no such interfaces. The relevant
> "APIs" are VS Code extension contribution points and test contract interfaces.
...
> and tenant provisioning. This cleanup has no external deployment. The
> relevant runtime considerations are extension packaging and workspace sync.
