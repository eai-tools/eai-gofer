...
Gofer exposes 6 MCP tools that AI assistants (Claude Code, GitHub Copilot) can call directly.

### Tool Discovery

Tools are auto-registered in `.vscode/mcp.json` when running `Gofer: Initialize Repository`.
...
**Authentication:** None required for MCP tools
