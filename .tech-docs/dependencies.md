...
**Dependency:** GitHub Releases API
**Type:** External API
**Authentication:** Public API (no auth required)
**Usage:** Auto-update checks
**Critical:** No
...
**Integration:** MCP tools via VSCode
**Usage:** Reads specs, executes tasks, validates code
**Version:** Latest
...
**Type:** Any MCP-compatible client
