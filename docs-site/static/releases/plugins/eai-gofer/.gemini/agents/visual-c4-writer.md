...
description: Writes C4 Context and C4 Container diagrams for feature visuals from spec/research/plan input. Outputs Mermaid C4 blocks with named external systems.
kind: local
