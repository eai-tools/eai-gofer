...
export class MCPToolHandler {
  ...
  private logSecurityViolation(message: string, details: Record<string, unknown>): void {
    ...
    this.connection.sendNotification('eaiGofer/securityViolation', logEntry);
  }
  ...
  /**
   * MCP Tool: eaigofer_get_next_task
  ...
  /**
   * MCP Tool: eaigofer_execute_task
  ...
  /**
   * MCP Tool: eaigofer_update_task_status
  ...
  async updateTaskStatus(
    ...
    try {
      ...
      this.connection.sendNotification('eaiGofer/taskProgress', {
        specId,
        taskId,
        status,
  ...
  /**
   * MCP Tool: eaigofer_validate_code
