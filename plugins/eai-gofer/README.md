...
- VS Code extension: `https://eai-tools.github.io/eai-gofer/releases/eai-gofer-3.4.1.vsix`
- Agent plugin zip: `https://eai-tools.github.io/eai-gofer/releases/eai-gofer-agent-plugin-3.4.1.zip`
...
```bash
curl -fsSL https://eai-tools.github.io/eai-gofer/releases/eai-gofer-agent-plugin-3.4.1.zip -o /tmp/eai-gofer-agent-plugin-3.4.1.zip

rm -rf ~/plugins/eai-gofer
unzip /tmp/eai-gofer-agent-plugin-3.4.1.zip -d ~/plugins
```
