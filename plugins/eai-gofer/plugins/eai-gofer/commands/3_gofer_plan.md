...
2. **EAI app-readiness handoff** — for EAI app delivery, reference
   ...
   - block-catalog readiness and package-profile compatibility evidence If EAI
     readiness is blocked, plan only the smallest unblock task group and do not
     invent object types, tenant IDs, app keys, or platform capabilities.
3. **EAI Platform/Azure app stack decision** — for app delivery, the plan MUST
   ...
   silently.
4. **Deployment convention** — reference the configured deployment documentation
...
9. **EnterpriseAI service-fit handoff** — for app delivery, the plan MUST
   ...
   - unavailable without new platform work The plan must source this evidence
     ...
     platform evidence.
10. **Reuse-before-create decision log** — reference
...
12. **Public/private knowledge split** — identify which implementation facts are
