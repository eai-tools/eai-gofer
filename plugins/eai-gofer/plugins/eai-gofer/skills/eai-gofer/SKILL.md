...
name: eai-gofer
description:
  'Run the public Gofer spec-driven delivery workflow in Claude, Gemini, Codex,
  or Copilot.'
---
...
- `6a_gofer_engineering_review` - Run a targeted engineering review on a
  specific component or concern.
