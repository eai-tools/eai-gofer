...
describe('Test Fixtures Usage Examples', () => {
  ...
  describe('Test Scenarios', () => {
    it('should provide pre-configured test scenarios', () => {
      ...
      const successScenario = scenarios.successful_validation as { expectedOutput: { isValid: boolean; qualityScore: number } };
  ...
  describe('Environment Setup', () => {
    it('should setup test environment correctly', () => {
      ...
      expect(process.env.ANTHROPIC_API_KEY).toBe('test-claude-key-12345');
    });
