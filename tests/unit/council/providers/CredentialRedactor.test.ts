...
describe('CredentialRedactor (T068)', () => {
  describe('redactCredentials', () => {
    ...
    it('should redact OpenAI API keys', () => {
      const history: ConversationMessage[] = [
        {
          role: 'user',
          content: 'Use sk-proj-abcd1234efgh5678ijkl9012mnop3456',
        },
      ];

      const redacted = redactCredentials(history);

      expect(redacted[0].content).not.toContain('sk-proj-abcd1234efgh5678ijkl9012mnop3456');
    ...
    it('should redact GitHub tokens', () => {
      ...
      expect(redacted[0].content).not.toContain('ghp_1234567890abcdefghijklmnopqrstuvwxyz');
    ...
    it('should redact multiple credentials in the same message', () => {
      const history: ConversationMessage[] = [
        {
          role: 'user',
          content: 'Use sk-test1234567890123 and ghp_abcdefghijklmnopqrstuvwxyz1234567890',
        },
      ];
      ...
      expect(redacted[0].content).not.toContain('ghp_abcdefghijklmnopqrstuvwxyz1234567890');
      expect(redacted[0].content).toContain('[REDACTED');
    });
  ...
  describe('containsCredentials', () => {
    ...
    it('should detect GitHub tokens', () => {
      expect(containsCredentials('ghp_1234567890abcdefghijklmnopqrstuvwxyz')).toBe(true);
    });
